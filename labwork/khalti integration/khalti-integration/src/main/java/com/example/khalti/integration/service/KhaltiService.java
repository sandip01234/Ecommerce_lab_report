...
//        headers.setBearerAuth(khaltiConfig.getSecretKey());
//
//        HttpEntity<PaymentRequest> entity = new HttpEntity<>(request, headers);
//
//        try {
//            ResponseEntity<PaymentResponse> response = restTemplate.postForEntity(
//                    khaltiConfig.getBaseUrl() + "/initiate/",
//                    entity,
...
//                String transactionId = response.getBody().getPaymentUrl().split("=")[1];
...
//    }
//
//    public LookupResponse verifyTransaction(String transactionId) {
...
//                    khaltiConfig.getBaseUrl() + "/lookup/" + transactionId,
//                    HttpMethod.GET,
//                    entity,
...
//                    payment.setAmount(lookup.getAmount());
